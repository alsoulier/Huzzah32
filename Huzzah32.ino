/**
 * @file Huzzah32.ino
 * @brief Test application for the MCP24LC512 class.
 *
...
//    Serial.printf("Manufacturer's ID = 0x%02X\n", id);
//    digitalWrite(SPI.pinSS(), HIGH);
//    SPI.endTransaction();
//}

//MCP24LC512 mcp24lc512;  /**< MCP24LC512 object. */
//
//TwoWire mywire(0);      /**< User defined MCU I2C bus object. */
//
///**
// * @fn void output(const uint16_t)
// * @brief Output data read from EEPROM.
// *
// * Output to Serial object the data byte read from mcp24lc512 object.
// *
// * @param address Address of data.
// */
//void output(const uint16_t address) {
//    Serial.printf("[DATA] address %d data 0x%02X\n", address, mcp24lc512.read(address));
//}
//
///**
// * @fn void setup()
...
// * - Setup the user defined I2C bus.
// * - Initializes the MCP24LC512 object.
// * - Output to Serial byte read from EEPROM at address 0.
// * - Clean up.
// */
//void setup() {
//    Serial.begin(921600);
...
// *
// * No real work done.
// * Call to delay function to avoid watchdog triggering.
// */
//[[gnu::optimize("O0")]] void loop() {
//    bool _loop = true;
//    while(_loop) {
//        delay(100);
//    }
